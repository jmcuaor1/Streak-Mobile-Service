...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    // El listener ahora llama al método del provider
    _searchController.addListener(() {
      context.read<JobProvider>().filterJobs(_searchController.text);
    });
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Usamos un Consumer para escuchar los cambios del JobProvider
              Consumer<JobProvider>(
                builder: (context, jobProvider, child) {
                  return _buildRecentJobsList(jobProvider);
                },
              ),
  ...
  Widget _buildRecentJobsList(JobProvider jobProvider) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16.0),
      child: ListView.builder(
        // Muestra 3 placeholders mientras carga, o la lista real
        itemCount: jobProvider.isLoading ? 3 : jobProvider.filteredJobs.length,
        shrinkWrap: true,
        ...
        itemBuilder: (context, index) {
          if (jobProvider.isLoading) {
            ...
            return _buildJobCard(context, jobProvider.filteredJobs[index]);
          }
        },
      ),
    );
